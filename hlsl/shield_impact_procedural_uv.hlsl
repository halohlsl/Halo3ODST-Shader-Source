//#line 2 "source\rasterizer\hlsl\shield_impact_procedural_uv.hlsl"
...
accum_pixel default_ps(s_vertex_out pixel_in)
{
	...
	noise_value2= sample2D(shield_impact_noise_texture2, (pixel_in.texcoord.xy - float2(time_parameter / 11.0f, time_parameter / 17.0f)) * texture_quantities.z);
