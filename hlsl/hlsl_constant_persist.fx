...
CBUFFER_BEGIN(StipplePS)
	CBUFFER_CONST(StipplePS,			float,		stipple_threshold,					k_ps_stipple_threshold)
	CBUFFER_CONST(StipplePS,			float3,		stipple_threshold_pad,				k_ps_stipple_threshold_pad)
CBUFFER_END
...
PIXEL_TEXTURE(_2D,		stipple_texture,				k_stipple_texture,						19)
