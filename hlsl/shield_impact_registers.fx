...
PIXEL_CONSTANT(float, shield_impact_edge_fade, k_ps_shield_impact_edge_fade)
...
CBUFFER_BEGIN(ShieldImpactPS)
	...
	CBUFFER_CONST(ShieldImpactPS,	float,		shield_impact_edge_fade,			k_ps_shield_impact_edge_fade)
	CBUFFER_CONST(ShieldImpactPS,	float3,		shield_impact_edge_fade_pad,		k_ps_shield_impact_edge_fade_pad)
CBUFFER_END
