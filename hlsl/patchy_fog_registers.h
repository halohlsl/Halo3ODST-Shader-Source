...
#define k_ps_patchy_fog_atmosphere_constant_0		CONSTANT_NAME(133)
#define k_ps_patchy_fog_atmosphere_constant_1		CONSTANT_NAME(134)
#define k_ps_patchy_fog_atmosphere_constant_2		CONSTANT_NAME(135)
#define k_ps_patchy_fog_atmosphere_constant_3		CONSTANT_NAME(136)
#define k_ps_patchy_fog_atmosphere_constant_4		CONSTANT_NAME(137)
#define k_ps_patchy_fog_atmosphere_constant_5		CONSTANT_NAME(138)
#define k_ps_patchy_fog_atmosphere_constant_extra	CONSTANT_NAME(139)
