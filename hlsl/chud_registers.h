...
#define k_vs_chud_basis_01			 		CONSTANT_NAME(24)
#define k_vs_chud_basis_23			 		CONSTANT_NAME(25)
#define k_vs_chud_basis_45			 		CONSTANT_NAME(26)
#define k_vs_chud_basis_67			 		CONSTANT_NAME(27)
#define k_vs_chud_basis_8			 		CONSTANT_NAME(43)
