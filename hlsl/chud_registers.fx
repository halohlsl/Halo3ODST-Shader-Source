...
VERTEX_CONSTANT(float4, chud_basis_01, k_vs_chud_basis_01);
VERTEX_CONSTANT(float4, chud_basis_23, k_vs_chud_basis_23);
VERTEX_CONSTANT(float4, chud_basis_45, k_vs_chud_basis_45);
VERTEX_CONSTANT(float4, chud_basis_67, k_vs_chud_basis_67);
VERTEX_CONSTANT(float4, chud_basis_8, k_vs_chud_basis_8);
