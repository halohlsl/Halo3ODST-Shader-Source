...
/*--------------------------------------------------------------------------*/
    float4 rgbyM = sample2Dlod(tex, pos.xy, 0.0);
    #if (FXAA_GREEN_AS_LUMA == 0)
...
/*--------------------------------------------------------------------------*/
    float4 rgbyN1 = sample2Dlod(fxaaConsole360TexExpBiasNegOne, pos.xy + dir1.xy, 0.0);
    float4 rgbyP1 = sample2Dlod(fxaaConsole360TexExpBiasNegOne, pos.xy + dir1.zw, 0.0);
    float4 rgbyN2 = sample2Dlod(fxaaConsole360TexExpBiasNegTwo, pos.xy + dir2.xy, 0.0);
    float4 rgbyP2 = sample2Dlod(fxaaConsole360TexExpBiasNegTwo, pos.xy + dir2.zw, 0.0);
/*--------------------------------------------------------------------------*/
